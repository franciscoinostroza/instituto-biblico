...
class InstitutoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DocumentoInstituto::create([
            'title'     => 'Reglamento Académico 2024',
            'file_path' => 'documentos/reglamento-2024.pdf',
            'category'  => 'reglamentos',
        ]);

        DocumentoInstituto::create([
            'title'     => 'Calendario Académico 2024',
            'file_path' => 'documentos/calendario-2024.pdf',
            'category'  => 'calendarios',
        ]);

        CalendarioAcademico::create([
